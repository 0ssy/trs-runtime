...
| 4.5 Non-Silent Conflict        | `verifier.py::verify_non_silent_conflict` | `conformance/conflict/test_conflict_visibility.py`, `tests/test_network_sync.py::test_partition_divergent_subject_chains_surface_conflict_on_reconnect` | `ATTACK-010_hidden-conflict.md` |
...
| 5.4 Checkpoint Anchoring       | `verifier.py::verify_checkpoint_anchor`, `sync.py::build_checkpoint_record` | `tests/test_checkpoints.py`                           | `ATTACK-012_partition-reconnection-sync.md` |
